...
*/
let fruits = ["Apple", "Banana", "Orange", "Mango"];  //array data type     
console.log("Fruits Array:", fruits);  // Display the array(fruits) value

// Accessing array elements
console.log("First Fruit:", fruits[0]);  // Accessing first element
console.log("Second Fruit:", fruits[1]); // Accessing second element
console.log("Third Fruit:", fruits[2]);  // Accessing third element
console.log("Fourth Fruit:", fruits[3]); // Accessing fourth element

// Array length
console.log("Number of Fruits:", fruits.length); // Display the length of the array(fruits)

// Adding an element to the array
fruits.push("Pineapple");
console.log("Fruits Array after adding Pineapple:", fruits);

// Removing the last element from the array
fruits.pop();
console.log("Fruits Array after removing last element:", fruits);
